...
import mn.foreman.dragonmint.DragonmintNetworkAction;
                ...
                new Object[][]{
                        {
                                ImmutableMap.of(
                                        "/api/updateNetwork",
                                        new HttpHandler(
                                                "dhcp=static&ipaddress=192.168.1.189&netmask=255.255.255.0&gateway=192.168.1.1&dns=%5B%22192.168.1.1%22%2C%22192.168.1.1%22%5D",
                                                "{\"success\": true}",
