...
import mn.foreman.dragonmint.DragonmintFactoryResetAction;
...
/** Test changing network settings on an Innosilicon. */
@RunWith(Parameterized.class)
public class InnosiliconNetworkITest
        extends AbstractAsyncActionITest {

    /**
     * Constructor.
     *
     * @param httpHandlers    The HTTP server handlers.
     * @param rpcHandlers     The RPC handlers.
     * @param includeHostname Whether or not the hostname should be changed.
     */
    public InnosiliconNetworkITest(
                ...
                new Object[][]{
                        {
                                ImmutableMap.of(
                                        "/api/updateNetwork",
                                        new HttpHandler(
                                                "dhcp=static&ipaddress=192.168.1.189&netmask=255.255.255.0&gateway=192.168.1.1&UserName2=my-test-username2&Password2=my-test-password2&Pool3=stratum%2Btcp%3A%2F%2Fmy-test-pool3.com%3A5588&UserName3=my-test-username3&Password3=my-test-password3",
                                                "{\"success\": true}",
