...
public class IBeLinkStatsITest
     ...
     */
    public IBeLinkStatsITest(
            final Map<String, HandlerInterface> rpcHandlers,
            final MinerStats stats) {
        super(
                new IBeLinkFactory(new ApplicationConfiguration())
                        .create(
                                ImmutableMap.of(
                                        "apiIp",
                                        "127.0.0.1",
                ...
                new Object[][]{
                        {
                                ...
                                new MinerStats.Builder()
                                        ...
                                        .addAsic(
                                                new Asic.Builder()
                                                        .setHashRate(new BigDecimal("10601538460000.00"))
                                                        .setBoards(3)
                                                        .setFanInfo(
                                                                new FanInfo.Builder()
                                                                        .setCount(0)
