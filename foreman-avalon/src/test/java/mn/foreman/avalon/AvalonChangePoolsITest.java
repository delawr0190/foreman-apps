...
/** Tests changing pools on an Avalon miner. */
@RunWith(Parameterized.class)
public class AvalonChangePoolsITest
                ...
                new Object[][]{
                        {
                                ...
                                ImmutableMap.of(
                                        ...
                                        new HttpHandler(
                                                "",
                                                "UpdatePageCallback({\"pageId\":\"cgconf\"});                CGConfCallback({                        \"pool1\":\"stratum+tcp://ss.antpool.com:3333#xnsub\",\n" +
                                                        "        \"worker1\":\"111.111\",                      \"passwd1\":\"123\",                        \"pool2\":\"stratum+tcp://sha256.antpool.com:3333#xnsub\",\n" +
                                                        "        \"worker2\":\"222.222\",                      \"passwd2\":\"456\",                        \"pool3\":\"stratum+tcp://sha256.mining-dutch.nl:9996#xnsub\",\n" +
                                                        "        \"worker3\":\"333.333\",                      \"passwd3\":\"789\",                        \"moreoption\":\"\",\n" +
                                                        "        \"mode\":\"1\"              });"),
                                        "/cgconf.cgi",
                                        new HttpHandler(
                                                "pool1=stratum%2Btcp%3A%2F%2Fmy-test-pool1.com%3A5588&worker1=my-test-username1&passwd1=my-test-password1&pool2=stratum%2Btcp%3A%2F%2Fmy-test-pool2.com%3A5588&worker2=my-test-username2&passwd2=my-test-password2&pool3=stratum%2Btcp%3A%2F%2Fmy-test-pool3.com%3A5588&worker3=my-test-username3&passwd3=my-test-password3&moreoption=&mode=1",
                                                ""),
                                        "/reboot.cgi",
                                        new HttpHandler(
                                                "reboot=1",
