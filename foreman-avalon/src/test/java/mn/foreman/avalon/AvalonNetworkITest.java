...
public class AvalonNetworkITest
     ...
     */
    public AvalonNetworkITest(final Map<String, HandlerInterface> rpcHandlers) {
        super(
                8080,
                4028,
                ...
                new Object[][]{
                        {
                                // Avalon 1047
                                ImmutableMap.of(
                                        "ascset|0,ip,s,192.168.1.189,255.255.255.0,192.168.1.1",
                                        new RpcHandler(
                                                ""),
                                        "ascset|0,dns,192.168.1.1,192.168.1.1",
                                        new RpcHandler(
                                                ""),
