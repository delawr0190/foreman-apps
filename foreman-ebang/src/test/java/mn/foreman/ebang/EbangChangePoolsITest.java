...
/** Test changing pools on an ebang. */
public class EbangChangePoolsITest
        extends AbstractAsyncActionITest {

    /** Constructor. */
    public EbangChangePoolsITest() {
        super(
                8080,
                8080,
                        ...
                        () -> new FakeHttpMinerServer(
                                ...
                                ImmutableMap.<String, ServerHandler>builder()
                                        ...
                                        .put(
                                                ...
                                                new HttpHandler(
                                                        "mip1=stratum%2Btcp%3A%2F%2Fmy-test-pool1.com%3A5588&mwork1=my-test-username1&mpassword1=my-test-password1&mip2=stratum%2Btcp%3A%2F%2Fmy-test-pool2.com%3A5588&mwork2=my-test-username2&mpassword2=my-test-password2&mip3=stratum%2Btcp%3A%2F%2Fmy-test-pool3.com%3A5588&mwork3=my-test-username3&mpassword3=my-test-password3",
                                                        ImmutableMap.of(
                                                                "Cookie",
