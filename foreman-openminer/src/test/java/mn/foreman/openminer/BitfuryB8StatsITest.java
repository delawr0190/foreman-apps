...
/** Runs an integration tests using {@link OpenMiner} against a fake API. */
@RunWith(Parameterized.class)
public class BitfuryB8StatsITest
                ...
                new Object[][]{
                        {
                                ImmutableMap.of(
                                        "/api/login",
                                        new HttpHandler(
                                                "{\"email\":\"test@example.com\",\"password\":\"Qw2Qw2Qw2\"}",
                                ...
                                new MinerStats.Builder()
                                        ...
                                        .addPool(
                                                new Pool.Builder()
                                                        .setName("ca.stratum.slushpool.com:3333")
                                                        .setWorker("xx.yy")
                                                        .setPriority(0)
                                                        .setStatus(
                                                                true,
                                        ...
                                        .addAsic(
                                                new Asic.Builder()
                                                        .setHashRate(new BigDecimal("48445500000000"))
                                                        .setBoards(6)
                                ...
                                ImmutableMap.of(
                                        ...
                                        new HttpHandler(
                                                ...
                                                "{\n" +
                                                        ...
                                                        "    },\n" +
                                                        "    \"psuI\": \"0.0\",\n" +
                                                        "    \"hwAddr\": \"16:bf:01:3b:3b:51\",\n" +
                                                        "    \"diff\": 512,\n" +
                                                        "    \"osc\": 48,\n" +
                                                        "    \"errorSpi\": 0\n" +
                                                        "  },\n" +
                                                        "  \"temperatureFanCold\": 42,\n" +
                                                        "  \"slaves\": [\n" +
                                                        "    {\n" +
                                                        "      \"ver\": \"0x00000000\",\n" +
