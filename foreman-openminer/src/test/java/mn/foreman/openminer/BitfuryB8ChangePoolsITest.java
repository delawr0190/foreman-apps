...
/** Test changing pools on an OpenMiner. */
public class BitfuryB8ChangePoolsITest
        extends AbstractAsyncActionITest {

    /** Constructor. */
    public BitfuryB8ChangePoolsITest() {
        super(
                8080,
                8080,
                ...
                Collections.singletonList(
                        () -> new FakeHttpMinerServer(
                                ...
                                ImmutableMap.of(
                                        ...
                                        new HttpHandler(
                                                "",
                                                "{\"host\":\"ca.stratum.slushpool.com\",\"port\":3333,\"user\":\"xx.yy\",\"password\":\"123\",\"fanV\":12,\"osc\":48,\"psuV\":51,\"ocp\":96,\"logDelay\":30,\"logChipStat\":false}"),
                                        "/api/om/miner/settings/apply",
                                        new HttpHandler(
                                                "{\"psuV\":51,\"password\":\"my-test-password1\",\"port\":5588,\"logChipStat\":false,\"host\":\"my-test-pool1.com\",\"fanV\":12,\"logDelay\":30,\"user\":\"my-test-username1\",\"ocp\":96,\"osc\":48}",
                                                "{\"psuV\":51,\"password\":\"my-test-password1\",\"port\":5588,\"logChipStat\":false,\"host\":\"my-test-pool1.com\",\"fanV\":12,\"logDelay\":30,\"user\":\"my-test-username1\",\"ocp\":96,\"osc\":48}"),
