...
public class BaikalChangePoolsITest
     ...
     */
    private static Map<String, Object> toNewArgs() {
        final Map<String, Object> args = new HashMap<>();
        TestUtils.toPoolJson().forEach(args::put);
        args.put("algo0", "algo_0_value");
        args.put("algo1", "algo_1_value");
        args.put("algo2", "algo_2_value");
        return args;
    }
     ...
     * @return The arguments.
     */
    private static Map<String, Object> toOldArgs() {
        final Map<String, Object> args = new HashMap<>();
        TestUtils.toPoolJson().forEach(args::put);
    ...
    /**
     * Creates test handlers.
     *
     * @return The handlers.
     */
    private static Map<String, HandlerInterface> toRpcHandlers() {
