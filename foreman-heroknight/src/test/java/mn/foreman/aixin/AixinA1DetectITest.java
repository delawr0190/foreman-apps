...
import mn.foreman.heroknight.AixinType;
import mn.foreman.heroknight.AixinTypeFactory;
...
/** Tests dection of an Aixin A1. */
public class AixinA1DetectITest
        extends AbstractDetectITest {

    /** Constructor. */
    public AixinA1DetectITest() {
        super(
